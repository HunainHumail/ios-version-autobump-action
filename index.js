...
Toolkit.run(async (tools) => {
    ...
    const versionMarketingRegexPattern = /MARKETING_VERSION = ([0-9]+.[0-9].[0-9])/g;
    ...
    let currentVersionName = versionCodeRegexPattern.exec(fileContent)[0].toString().replaceAll('CURRENT_PROJECT_VERSION = ','');
    let currentVersionNameMarketing = versionMarketingRegexPattern.exec(fileContent)[0].toString().replaceAll('MARKETING_VERSION = ','');
    ...
    let newFileContent = fileContent.toString().replaceAll(`CURRENT_PROJECT_VERSION = "${currentVersionName}"`, `CURRENT_PROJECT_VERSION = "${newVersionName}"`);
    newFileContent = newFileContent.toString().replaceAll(`MARKETING_VERSION = ${currentVersionNameMarketing}`, `MARKETING_VERSION = ${newMarketingVersionName}`)
    let newVersion;
